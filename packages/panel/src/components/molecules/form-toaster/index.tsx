...
const DiscardButton: React.FC<HTMLAttributes<HTMLButtonElement>> = ({ children, className, ...props }) => {
  return (
    <button
      className={clsx("flex items-center justify-center text-white inter-small-semibold h-full w-full", className)}
      {...props}
    >
      {children}
    </button>
...
const ActionButton: React.FC<HTMLAttributes<HTMLButtonElement>> = ({ children, className, ...props }) => {
  return (
    <button
      className={clsx("flex items-center justify-center text-white inter-small-semibold h-full w-full", className)}
      {...props}
...
const MultiActionButton: React.FC<MultiActionButtonProps> = ({ children, className, actions }) => {
  return (
    <Dropdown.Root>
      <Dropdown.Trigger
        className={clsx("inter-small-semibold flex items-center justify-center h-full w-full", className)}
      >
        {children}
