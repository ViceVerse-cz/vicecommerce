 ...
 */
export const TablePagination = <T,>({ count = 0, table, className }: Props<T>) => {
  const { getState, getPageCount, getCanNextPage, getCanPreviousPage, previousPage, nextPage } = table;
  ...
  return (
    <div className={clsx("inter-small-regular text-grey-50 flex items-center justify-between", className)}>
      <div>
