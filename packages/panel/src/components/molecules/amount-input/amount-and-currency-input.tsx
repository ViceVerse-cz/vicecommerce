...
const AmountAndCurrencyInput = ({ label, errors, name, value, onChange, onBlur }: Props) => {
  ...
  const [formattedValue, setFormattedValue] = useState<string | undefined>(
    value.amount !== undefined && value.amount !== null ? getFormattedValue(value.amount) : undefined,
  );
