...
const NativeSelect: NativeSelectType = ({ children, triggerProps, ...props }) => {
  return (
...
const Item: React.FC<ItemProps> = ({ children, ...props }) => (
  <RadixSelect.Item
    className={clsx("flex relative justify-start py-1.5 px-9 items-center inter-base-regular rounded hover:bg-grey-10")}
    {...props}
  >
