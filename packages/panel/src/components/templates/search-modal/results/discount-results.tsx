...
const DiscountResults = ({ discounts = [], getLIProps, offset, selected }: DiscountResultsProps) => {
  return discounts.length > 0 ? (
    <SectionCollapsible title={"Slevy"} length={discounts?.length || 0}>
            ...
            >
              ...
              >
                <div className='flex items-center gap-x-3'>
                  ...
                  <p className='inter-small-regular text-grey-90'>{discount.rule.description}</p>
                </div>
                <span
