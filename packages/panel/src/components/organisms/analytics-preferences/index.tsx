...
import AnalyticsConfigForm, { AnalyticsConfigFormType } from "../analytics-config-form";
...
const AnalyticsPreferencesModal = () => {
  ...
  const onSubmit = form.handleSubmit((data) => {
    ...
    mutate(config, {
      onSuccess: () => {
        notification("Úspěch", "Vaše předvolby byly úspěšně aktualizovány", "success");
      ...
      <FocusModal.Main>
        <div className='flex flex-col items-center'>
          <div className='mt-5xlarge flex flex-col max-w-[664px] w-full'>
            <h1 className='inter-xlarge-semibold mb-large'>Pomozte nám zlepšit se</h1>
            <p className='text-grey-50'>
              Abychom vytvořili co nejpřesvědčivější zážitek z elektronického obchodování, chtěli bychom. získat
              informace o tom, jak Medusu používáte. Poznatky o uživatelích nám umožňují vytvářet lepší, poutavější a
              použitelnější produkty. Pouze sbíráme data pro vylepšování produktů. Přečtěte si, jaká data shromažďujeme
              v našich stránkách .{" "}
              <a
            ...
            <div className='flex items-center justify-end mt-5xlarge'>
              <Button variant='primary' size='small' loading={isLoading} onClick={onSubmit}>
                Pokračovat
              </Button>
            </div>
          </div>
