...
function MedusaPriceInput(props: MedusaPriceInputProps) {
  const [rawValue, setRawValue] = React.useState<string | undefined>(`${props.amount || 0}`);
  ...
  const onAmountChange: PriceInputProps["onAmountChange"] = (value?: string, floatValue?: number | null) => {
  ...
  return <PriceInput amount={rawValue} onAmountChange={onAmountChange} currency={currency} />;
}
