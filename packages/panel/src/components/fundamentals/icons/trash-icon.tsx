...
const TrashIcon: React.FC<IconProps> = ({ size = "24px", color = "currentColor", ...attributes }) => {
  return (
    <svg width={size} height={size} viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' {...attributes}>
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M11.666 9.23726V13.4039' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
};
