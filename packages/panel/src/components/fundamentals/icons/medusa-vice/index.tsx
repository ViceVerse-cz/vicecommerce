...
const MedusaVice: React.FC<IconProps> = ({ size = "96", color = "currentColor", ...attributes }) => {
  return (
    <svg width={size} height={size} viewBox='0 0 96 96' fill='none' xmlns='http://www.w3.org/2000/svg' {...attributes}>
      <path
