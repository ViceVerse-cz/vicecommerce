...
const SidedMouthFaceIcon: React.FC<IconProps> = ({ size = "24", color = "currentColor", ...attributes }) => {
  return (
    <svg width={size} height={size} fill='none' viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg' {...attributes}>
      <path
