...
const UnpublishIcon: React.FC<IconProps> = ({ size = "20", color = "currentColor", ...attributes }) => {
  return (
    <svg width={size} height={size} viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' {...attributes}>
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M10 13.3333V16.6667' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path
