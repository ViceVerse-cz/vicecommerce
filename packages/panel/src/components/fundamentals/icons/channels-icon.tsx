...
const ChannelsIcon: React.FC<IconProps> = ({ size = "24px", color = "currentColor", ...attributes }) => {
  return (
    <svg width={size} height={size} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...attributes}>
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M15.6361 12H7.53613' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
};
