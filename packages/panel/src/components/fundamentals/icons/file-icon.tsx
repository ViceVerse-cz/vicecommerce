  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M10.833 13.75H3.33301' stroke={line} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M7.08301 10V17.5' stroke={line} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
};
