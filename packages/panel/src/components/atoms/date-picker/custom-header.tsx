  ...
  return (
    <div className='flex w-full gap-4 items-center'>
      <div className='flex flex-1 items-center justify-end gap-3'>
        <NativeSelect defaultValue={monthName} onValueChange={(v) => changeMonth(monthNames.indexOf(v))}>
      ...
      <div className='flex flex-1 items-center justify-start gap-3'>
        <NativeSelect defaultValue={year.toString()} onValueChange={(v) => changeYear(parseInt(v, 10))}>
