 ...
 */
export const getAnalyticsConfig = async (): Promise<AdminAnalyticsConfigRes> => {
 ...
 */
export const createAnalyticsConfig = async (payload: CreateConfigPayload): Promise<AdminAnalyticsConfigRes> => {
 ...
 */
export const updateAnalyticsConfig = async (payload: UpdateConfigPayload): Promise<AdminAnalyticsConfigRes> => {
...
export const useAdminAnalyticsConfig = () => {
  ...
  const { data, ...rest } = useQuery(ANALYTICS_CONFIG_KEY, () => getAnalyticsConfig(), {
    retry: false,
...
export const useAdminUpdateAnalyticsConfig = () => {
  ...
  const mutation = useMutation((payload: UpdateConfigPayload) => updateAnalyticsConfig(payload), {
...
export const useAdminCreateAnalyticsConfig = () => {
  ...
  const mutation = useMutation((payload: CreateConfigPayload) => createAnalyticsConfig(payload), {
    onSuccess: invalidateAnalyticsConfig,
  });
