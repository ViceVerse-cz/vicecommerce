    ...
    >
      <div className='flex gap-2 overflow-hidden'>
        ...
        <div className='block overflow-hidden truncate'>
          <h3 className='mb-1 font-semibold leading-5 text-grey-90'>{salesChannel.name}</h3>
...
function SalesChannelDetailsHeader(props: SalesChannelDetailsHeaderProps) {
  ...
  return (
    <div className='flex items-center justify-between'>
      <h2 className='mb-4 font-semibold text-xlarge text-grey-90'>{salesChannel.name}</h2>
      <div className='flex items-center justify-between gap-4'>
        <StatusSelector
