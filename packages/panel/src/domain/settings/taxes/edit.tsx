    ...
    <LayeredModal isLargeModal context={layeredModalContext} handleClose={onDismiss}>
      <Modal.Body>
        <Modal.Header handleClose={onDismiss}>
          <div>
            <h1 className='inter-xlarge-semibold'>Upravit sazbu daně</h1>
          </div>
        </Modal.Header>
        {taxRate.type === "region" ? (
          ...
          <EditForm regionId={regionId} modalContext={layeredModalContext} taxRate={tax_rate} onDismiss={onDismiss} />
        )}
      </Modal.Body>
    </LayeredModal>
  );
