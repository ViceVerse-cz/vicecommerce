...
import { FieldValues, FormProvider, SubmitHandler, useForm, useFormContext, useWatch } from "react-hook-form";
import { weekFromNow } from "../../../../utils/date-utils";
import { ConfigurationField, CreatePriceListPricesFormValues, PriceListFormValues, PriceListType } from "../types";
...
const PriceListFormContext = React.createContext<{
  ...
  setPrices: React.Dispatch<React.SetStateAction<CreatePriceListPricesFormValues | null>>;
...
export const PriceListFormProvider: React.FC<FormProviderProps> = ({ priceList = defaultState, children }) => {
  ...
  const [prices, setPrices] = useState<CreatePriceListPricesFormValues | null>(null);
