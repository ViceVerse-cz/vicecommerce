...
const PricingDetails = () => {
  ...
  return (
    <div className='pb-xlarge'>
      <Breadcrumb currentPage='Upravit ceník' previousBreadcrumb='Stanovení cen' previousRoute='/a/pricing' />
      ...
      {!isLoading && price_list ? (
        <PriceListFormProvider priceList={mapPriceListToFormValues(price_list)}>
          ...
          <div className='mt-xlarge'>
            <RawJSON data={price_list} title='Ceník surovin' rootName='price_list' />
          </div>
