...
import ImageTable, { ImageTableDataType } from "../../../../components/templates/image-table";
                ...
                {fields.map((field, index) => {
                  return (
                    <div key={field.id} className='flex items-center'>
                      <input className='hidden' {...form.register(`images.${index}.url`)} defaultValue={field.url} />
                      {field.nativeFile && (
                        <>
                          <input
                            className='hidden'
