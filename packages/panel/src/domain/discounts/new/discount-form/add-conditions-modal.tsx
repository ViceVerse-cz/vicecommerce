...
const AddConditionsModal = ({ onClose, conditions, save, isDetails = false }: AddConditionsModalProps) => {
  const layeredModalContext = useContext(LayeredModalContext);

  const [items, setItems] = useState<ConditionItem[]>(useConditionModalItems({ onClose, isDetails }));
