...
import VariantSelectOptionsForm, { VariantOptionValueType, VariantSelectOptionsFormType } from ".";
...
storiesOf("Domains/Product/Components/VariantForm/VariantOptionsForm", module).add("Base", () => {
  ...
  return (
    <div>
      <VariantSelectOptionsForm form={nestedForm(form, "options")} options={opts} onCreateOption={onCreateOption} />
