...
export const DisplayTotal = ({
  ...
  <div className='flex justify-between mt-4 items-center'>
    ...
    <DisplayTotalAmount totalAmount={totalAmount} currency={currency} variant={variant} totalColor={totalColor} />
  </div>
);

export const DisplayTotalAmount = ({ totalColor = "text-grey-90", variant = "regular", totalAmount, currency }) => (
  <div className='flex'>
    <div
    ...
    {variant === "regular" && <div className='inter-small-regular text-grey-50'>{currency.toUpperCase()}</div>}
  </div>
);
