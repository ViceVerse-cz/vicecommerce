...
const AddReasonScreen = ({ reasonDetails, index, isClaim = false, addReasonDetails }: Props) => {
    ...
    <>
      <Modal.Content>
        <div className="flex flex-col gap-y-base">
          ...
          />
          <TextArea label="Note" placeholder="Product was damaged during shipping" {...register("note")} />
        </div>
      </Modal.Content>
      <Modal.Footer>
        <div className="flex w-full items-center justify-end gap-x-xsmall">
          ...
          <Button size="small" variant="primary" onClick={onSubmit} disabled={!isDirty} type="button">
            Save and go back
          </Button>
        </div>
      </Modal.Footer>
