...
const ShippingAddressForm = ({ form, order }: Props) => {
  ...
  const { address_1, address_2, city, country_code, company, postal_code, province } = useWatch({
    control,
    name: path(),
  });
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="secondary" size="small" type="button" onClick={() => pushScreen({ form, order })}>
