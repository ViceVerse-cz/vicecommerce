              ...
              >
                ...
                {!token ? (
                  <div className='h-full flex flex-col gap-y-2 text-center items-center justify-center'>
                    <span className='inter-large-semibold text-grey-90'>You signup link is invalid</span>
                  ...
                  <>
                    <span className='inter-2xlarge-semibold mt-4 text-grey-90'>Welcome to the team!</span>
                    <span className='inter-base-regular text-grey-50 mt-2 mb-large'>Create your account below👇🏼</span>
                    <SigninInput
                    ...
                    <Link to='/login' className='inter-small-regular text-grey-50 mt-large'>
        ...
        <div className='bg-grey-90 h-screen w-full overflow-hidden'>
          <div className='z-10 flex-grow flex flex-col items-center justify-center h-full absolute inset-0 max-w-[1080px] mx-auto'>
            ...
            <div className='flex flex-col items-center max-w-3xl text-center'>
              <h1 className='inter-3xlarge-semibold text-grey-0 mb-base'>You have been invited to join the team</h1>
              <p className='inter-xlarge-regular text-grey-50'>
                You can now join the Medusa Store team. Sign up below and get started with your Medusa Admin account
                right away.
              </p>
            </div>
            <div className='mt-4xlarge'>
              <Button size='large' variant='primary' className='w-[280px]' onClick={() => setSignUp(true)}>
                Sign up
