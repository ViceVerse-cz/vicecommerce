  ...
  return (
    <div className="text-small-regular">
      ...
      <Disclosure>
        <Disclosure.Panel
          static
          className={clsx("transition-[max-height,opacity] duration-300 ease-in-out overflow-hidden", {
        ...
        >
          <div className="flex flex-col gap-y-2 py-4">
            ...
            <div className="flex items-center justify-end mt-2">
              <Button isLoading={isLoading} className="w-full small:max-w-[140px]" type="submit">
                Save changes
              </Button>
            </div>
          </div>
