    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-x-4">
          <button className="text-small-regular text-gray-700 flex items-center gap-x-2" onClick={open}>
            <Edit size={16} />
            Edit
          </button>
          <button className="text-small-regular text-gray-700 flex items-center gap-x-2" onClick={removeAddress}>
            <Trash />
            Remove
          </button>
        </div>
      ...
      <Modal isOpen={state} close={close}>
        ...
        <Modal.Body>
          <div className="grid grid-cols-1 gap-y-2">
            ...
            <Input label="Province / State" {...register("province")} errors={errors} autoComplete="address-level1" />
          ...
          {error && <div className="text-rose-500 text-small-regular py-2">{error}</div>}
        </Modal.Body>
        <Modal.Footer>
