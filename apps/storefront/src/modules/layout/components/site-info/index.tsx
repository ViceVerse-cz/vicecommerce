        ...
        {({ open }) => {
          return (
            <>
              ...
              <Disclosure.Panel
                static
                className={clsx("transition-[max-height,opacity] duration-700 ease-in-out overflow-hidden", {
...
const AnimatedButton = ({ open }: { open: boolean }) => {
  return (
    <div className="w-[15px] h-[15px] relative cursor-pointer">
      ...
      <div
        className={clsx("bg-gray-900 absolute left-[7px] inset-y-0 w-px transition-all duration-300 ease-out", {
          "rotate-90": open,
        })}
      />
    </div>
