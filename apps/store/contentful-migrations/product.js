module.exports = function (migration, context) {
  const product = migration.createContentType('product').name('Product').displayField('title');
  ...
  product.createField('thumbnail').name('Thumbnail').type('Link').linkType('Asset');
