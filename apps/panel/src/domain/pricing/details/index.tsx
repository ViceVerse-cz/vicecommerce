...
const PricingDetails = () => {
  ...
  return (
    <div className='pb-xlarge'>
      <Breadcrumb currentPage='Edit price list' previousBreadcrumb='Pricing' previousRoute='/a/pricing' />
      ...
      {!isLoading && price_list ? (
        <PriceListFormProvider priceList={mapPriceListToFormValues(price_list)}>
          ...
          <div className='mt-xlarge'>
            <RawJSON data={price_list} title='Raw price list' rootName='price_list' />
          </div>
