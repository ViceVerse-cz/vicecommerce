            ...
            >
              <Controller
                ...
                render={({ field: { value, onChange } }) => {
                  ...
                  return (
                    <>
                      <DatePicker date={ensuredDate} label='Start date' onSubmitDate={onChange} />
                      <TimePicker date={ensuredDate} label='Start date' onSubmitDate={onChange} />
                    </>
                  );
                }}
              />
            ...
            >
              <Controller
                ...
                render={({ field: { value, onChange } }) => {
                  ...
                  return (
                    <>
                      <DatePicker date={ensuredDate} label='End date' onSubmitDate={onChange} />
                      <TimePicker date={ensuredDate} label='End date' onSubmitDate={onChange} />
                    </>
                  );
                }}
              />
