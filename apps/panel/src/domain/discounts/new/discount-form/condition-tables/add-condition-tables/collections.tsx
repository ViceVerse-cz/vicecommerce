...
const AddCollectionConditionSelector = ({ onClose }: AddConditionSelectorProps) => {
  ...
  return (
    <>
      ...
      <Modal.Footer>
        <AddConditionFooter type='product_collections' items={items} onClose={onClose} operator={operator} />
      </Modal.Footer>
    </>
  );
};
