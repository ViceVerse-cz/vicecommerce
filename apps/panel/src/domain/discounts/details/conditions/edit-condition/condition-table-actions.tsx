...
const ExistingConditionTableActions = ({ numberOfSelectedRows, onDeselect, onRemove }: Props) => {
    ...
    <div className='flex space-x-xsmall h-[34px] overflow-hidden'>
      <div className={clsx("transition-all duration-200", classes)}>
        <div className='divide-x flex items-center h-[34px] mb-2'>
          <span className='mr-3 inter-small-regular text-grey-50'>{numberOfSelectedRows} vybraných</span>
