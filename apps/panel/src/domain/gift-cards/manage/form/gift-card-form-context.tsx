...
export const GiftCardFormProvider = ({ giftCardId, giftCard, children }: GiftCardFormProviderProps) => {
...
const GiftCardFormContext = React.createContext<{
  onUpdate: (e?: React.BaseSyntheticEvent<object, any, any> | undefined) => Promise<void>;
  resetForm: () => void;
