...
export const AddAdditionalItemsTable = ({ instance, isLoadingData, setSearchTerm }: Props) => {
  ...
  return (
    <LoadingContainer isLoading={isLoadingData}>
      <Table enableSearch searchPlaceholder="Search products" searchValue={query} handleSearch={setQuery}>
        <Table.Head>
