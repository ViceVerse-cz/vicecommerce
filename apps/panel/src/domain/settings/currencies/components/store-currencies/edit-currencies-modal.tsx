...
const EditCurrenciesModalContext = createContext<EditCurrenciesModalContextType | null>(null);
...
export const useEditCurrenciesModal = () => {
  ...
  if (!context) {
    throw new Error('useEditCurrenciesModal must be used within EditCurrenciesModal');
  }
