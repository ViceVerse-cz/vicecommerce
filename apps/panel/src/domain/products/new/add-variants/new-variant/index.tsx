...
const NewVariant = ({
  ...
  return (
    <>
      ...
      >
        <div ref={ref} className='text-grey-40 cursor-move flex items-center justify-center'>
          <GripIcon size={20} />
        </div>
        <div className='flex justify-center flex-col ml-base'>
          <p className='inter-base-semibold'>
            ...
            {source.stock.sku && (
              <span className='inter-base-regular text-grey-50 ml-2xsmall'>({source.stock.sku})</span>
            )}
          </p>
      ...
      <Modal open={state} handleClose={closeAndReset}>
        <Modal.Body>
          ...
          <Modal.Content>
            <CreateFlowVariantForm form={localForm} options={options} onCreateOption={onCreateOption} />
          </Modal.Content>
          <Modal.Footer>
