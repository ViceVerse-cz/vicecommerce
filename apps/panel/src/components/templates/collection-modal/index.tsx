...
const CollectionModal: React.FC<CollectionModalProps> = ({ onClose, isEdit = false, collection }) => {
  const { mutate: update, isLoading: updating } = useAdminUpdateCollection(collection?.id!);
