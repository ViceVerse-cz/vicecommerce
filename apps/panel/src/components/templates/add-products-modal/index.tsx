...
const AddProductsModal = ({ close, initialSelection, onSave }: AddProductsModalProps) => {
  /* ************* Data ************  */
  ...
  const [selectedIds, setSelectedIds] = React.useState(initialSelection.map((prod) => prod.id));
