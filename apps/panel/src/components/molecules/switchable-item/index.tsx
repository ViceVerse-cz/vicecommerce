  ...
  return (
    <div>
      <div className='flex items-start justify-between'>
        ...
        <Switch checked={open} onClick={onSwitch} type='button' className='cursor-pointer' />
      </div>
      <div
        className={clsx('transition-[max-height,opacity] duration-500 ease-in-out overflow-hidden', {
