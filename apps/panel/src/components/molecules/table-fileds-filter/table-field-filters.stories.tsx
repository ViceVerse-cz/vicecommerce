  ...
  fields: [
    {
      ...
      label: ({ isSelected }) => (
        <span className='text-small text-grey-50'>
          <span className={clsx('text-grey-90', { 'font-semibold': isSelected })}>USD </span>
          (USA)
        </span>
      ),
    },
    {
      ...
      label: ({ isSelected }) => (
        <span className='text-small text-grey-50'>
          <span className={clsx('text-grey-90', { 'font-semibold': isSelected })}>DKK </span>
          (Denmark)
        </span>
      ),
    },
    {
      ...
      label: ({ isSelected }) => (
        <span className='text-small text-grey-50'>
          <span className={clsx('text-grey-90', { 'font-semibold': isSelected })}>HRK </span>
          (Croatia)
        </span>
      ),
    },
