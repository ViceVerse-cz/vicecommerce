        ...
        <div className='flex flex-col items-center'>
          <div className='mt-5xlarge flex flex-col max-w-[664px] w-full'>
            ...
            <p className='text-grey-50'>
              ...
              získat informace o tom, jak Medusu používáte. Poznatky o uživatelích nám umožňují vytvářet
              lepší, poutavější a použitelnější produkty. Pouze sbíráme data pro vylepšování produktů.
              Přečtěte si, jaká data shromažďujeme v našich stránkách .{' '}
              <a
